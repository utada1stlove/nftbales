...
```bash
wget -qO- https://raw.githubusercontent.com/utada1stlove/nftbales/refs/heads/old/scripts/nft-menu.sh | sudo bash
```

或者下载后使用：

```bash
wget https://raw.githubusercontent.com/utada1stlove/nftbales/refs/heads/old/scripts/nft-menu.sh
chmod +x nft-menu.sh
sudo ./nft-menu.sh
```
